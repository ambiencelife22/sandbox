            ...
            <div className='relative bg-[#54005C] confirmation_page_container '>
                <div className='relative h-80 overflow-hidden  md:absolute md:left-0 md:h-full md:w-1/3 lg:w-1/2'>
                    <img
                        ...
                        src='https://firebasestorage.googleapis.com/v0/b/ambiencelife.appspot.com/o/images%2Fimages_global%2Fimages_misc%2Forca-underwater.webp?alt=media&token=e4fef85c-8489-4920-9a47-153b3d26dde0'
                        alt='Beautiful orca underwater'
                    />
                </div>
                <div className='relative mx-auto max-w-7xl py-12 sm:py-32 lg:px-8 lg:py-24'>
                    <div className='pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32 lg:tailwinmt-8'>
                        ...
                        <p className='pjs p_color text-center mt-4 text-base leading-7'>
                            Looks like that activity went swimming with the fishies!
                        </p>
                        <p className='pjs p_color text-center mt-4 text-base leading-7'>
                            If you didn't bring your scuba gear, you may want to get back on the boat! 
                        </p>
