                ...
                <div className='flex min-h-full items-center justify-center py-8 px-4 sm:px-6 lg:px-8  h-[90vh] dark text-light mb-[-50px]'>
                    <div className='w-full max-w-md space-y-8'>
                        <div>
                            ...
                            <h3 className='pjs p_color mb-20 text-center text-xl tracking-tight'>
                                We couldn't match your membership with the page you tried to access.
                            </h3>
                        </div>
