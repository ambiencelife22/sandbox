/* /app/courses-new/[courseId]/module/[moduleId]/submodule/[submoduleId]/components/SubmodulePage.tsx */
...
export default async function SubmodulePage({ courseId, moduleId, submoduleId }: SubmodulePageProps) {
