/* _BrickAppIntro.tsx in eh/page.tsx */
'use client'
...
interface BrickAppIntroCardProps {
    id: number
    icon: string
    name: string
    link: string
...
const BrickAppIntro: React.FC<BrickAppIntroCardProps> = (props: any) => {
    let cardData = introData[0]
    const classBase = 'activity_category_card activity_icon_card activity_icon_card_full_bg p-4 rounded-xl shadow-xl cursor-pointer intro_card_default'
            ...
            >
                ...
                >
                    ...
                    <div className={`dynamic_category_bg`}>
                        <h2 className='mt-2 activity_icon_text py-2 text-lg font-semibold relative w-full'>About The App</h2>
                        <div className=''>
