  ...
  const fetchExplanations = () => {
    ...
    setTimeout(() => {
      const dummyData = [
        {
          id: 1,
          text: 'Our SEEDS activity...',
        },
        {
          id: 2,
          text: '... is the first stage of our activities...',
        },
        {
          id: 3,
          text: '... providing an easy format to reinforce empowering phrases.',
        },
        {
          id: 4,
          text: 'The process is quite simple:\n\n1. Watch the phrase arrive onto the scene in a little rain droplet \n\n2. Drag the phrase into your heart \n\n3. Repeat until the timer runs out',
        },
        {
          id: 5,
          text: 'That\'s it!',
        ...
        {
          id: 10,
          text: 'P.S. We encourage you to say the phrases outloud as you drag them into the heart; and, again when they reappear reaffirmed!',
        },
      ]
