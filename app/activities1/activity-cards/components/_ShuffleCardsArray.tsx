...
export function useShuffleLogic() {
    ...
    useEffect(() => {
        const combinedPhrases = [...correctPhrases, ...incorrectPhrases, ...incorrectPhrases]
        setShuffledPhrases(shuffleArray(combinedPhrases))
    }, [correctPhrases, incorrectPhrases])
