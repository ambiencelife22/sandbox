  ...
  const fetchExplanations = () => {
    ...
    setTimeout(() => {
      const dummyData = [
        {
          id: 1,
          text: 'Our TYPER activity...',
        },
        {
          id: 2,
          text: '... is the second stage of our activities...',
        },
        {
          id: 3,
          text: '... providing a semi-easy format to reinforce empowering phrases.',
        },
        {
          id: 4,
          text: 'The process is quite simple:\n\n1. The empowering phrase is revealed \n\n2. Type what you see \n\n3. Repeat',
        },
        {
          id: 5,
          text: 'That\'s it!',
        ...
        {
          id: 7,
          text: 'To be flexible, Typer allows for minor punctuation errors and minor misspellings.',
        },
        {
          id: 8,
        ...
        {
          id: 11,
          text: 'P.S. We encourage you to say the phrases outloud as you type them; and, again when they reappear reaffirmed!',
        },
      ]
