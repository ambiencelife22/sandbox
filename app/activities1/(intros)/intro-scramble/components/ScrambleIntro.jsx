  ...
  const fetchExplanations = () => {
    ...
    setTimeout(() => {
      const dummyData = [
        {
          id: 1,
          text: 'Our SCRAMBLE activity...',
        },
        {
          id: 2,
          text: '... is the fourth stage of our activities...',
        },
        {
          id: 3,
          text: '... providing a challenging format to reinforce empowering phrases.',
        },
        {
          id: 4,
          text: 'The process is quite simple:\n\n1. The phrase is broken into pieces and mixed with random words \n\n2. Decipher the phrase and put the pieces together in the correct order \n\n3. Repeat!',
        },
        {
          id: 5,
          text: 'That\'s it!',
        ...
        {
          id: 10,
          text: 'P.S. We encourage you to say the empowering phrases outloud as you put them together; and, again when they reappear reaffirmed!',
        },
      ]
