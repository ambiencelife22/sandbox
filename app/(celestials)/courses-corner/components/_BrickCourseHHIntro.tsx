...
const BrickCoursesIntro: React.FC<BrickProps> = ({
    ...
    return (
        <Link href='courses-corner/intro-course-hh'>
            <motion.div 
            ...
            >
                ...
                >
                    ...
                    <div className={`dynamic_category_bg`}>
                        <h2 className='mt-2 activity_icon_text py-2 text-lg font-semibold relative w-full'>Human Harmony Intro</h2>
                        <div className=''>
